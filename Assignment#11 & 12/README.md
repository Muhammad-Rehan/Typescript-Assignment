...
```typescript
console.log(`${names[0]}, Welcome to the AI course`)
console.log(`${names[1]}, Welcome to the AI course`)
console.log(`${names[2]}, Welcome to the AI course`)
```
